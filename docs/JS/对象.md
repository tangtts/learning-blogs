...
<iframe
  ...
  width="100%"
  frameborder="1"
  src="//unpkg.com/javascript-playgrounds@^1.0.0/public/index.html?#data=%7B%22code%22%3A%22let%20x%20%3D%20%7B...undefined%7D%3Bconsole.log(x)%22%7D"
></iframe>
...
```
<blue> null 表示无对象，比如这个 document 本身应该有对象，但没有所以是 null </blue>
<br/>
<blue>undefined 表示没 value 值  </blue>
